...
<html>
   ...
   <body>
    ...
    <form action="{{url('add_comment')}}" method="post" style="display: inline-block;">
    @csrf
        <textarea style="width: 600px; height: 150px; display: block; margin: 0 auto;" placeholder="Comment something here" name="comment"></textarea>
        <br>
